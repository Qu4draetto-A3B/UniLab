 ...
 * istanze di {@link a3b.climate.magazzeno.Misurazione}.
 */
public class GestoreMisurazioni extends Gestore {
	 ...
	 * <p>
	 * Il record con i dati relativi alla {@link a3b.climate.magazzeno.Misurazione} viene aggiunto nel
	 * file CSV.
	 * <p>
	 * Nel caso in cui vi sia un errore nella scrittura del record, restituisce un
	 * {@link Result} con un codice di errore.
	 *
	 * @param mis {@link a3b.climate.magazzeno.Misurazione} da aggiungere al file CSV
	 * @return {@link Result} contenente la nuova istanza di {@link a3b.climate.magazzeno.Misurazione}
