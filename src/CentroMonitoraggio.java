		...
		do {
			switch (caso) {
				case 1:
					...
					do
					{
						System.out.print("Inserire l'area da aggiungere nel centro di monitoraggio (inserire valore compreso tra 1 e " +listatmp.size()+") \n");
						i = sc.nextInt();
						sc.nextLine();
				...
				case 2: // se cerco con le coordinate mi resituisce l'area geografica
						...
						System.out.println("Vuoi aggiungere l'area al centro di monitoraggio? \n inserire s per si \n inserire n per no \n");
